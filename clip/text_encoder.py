...
class Transformer(nn.Module):
    ...
    def encode_text(self, text):
        ...
        return x
'''
#a=torch.rand(1,77,512).type(torch.LongTensor)
a=torch.rand(1,77).type(torch.LongTensor)
v=nn.Embedding(49408,512)
d=nn.Parameter(torch.empty(77, 512))
b=Transformer(512,12,8)
...
a=torch.rand(1,77).type(torch.LongTensor)
c=C(1024,77,49408,512,8,12)
w=c(a)
print(w)
#torch.save(c,'text.pth')
torch.save(c.state_dict(), "text.pth")
